        ...
        <div class="-mx-4 flex flex-wrap">
            <div class="w-full p-4 lg:w-1/2">
                <img class="h-80 w-full rounded-lg object-cover duration-500 hover:scale-105 hover:shadow-xl "
                    src="{{asset('images/estudio.jpg')}}" alt="" />
            </div>
            <div class="w-full p-4 lg:w-1/2">
                <img class="h-80 w-full rounded-lg object-cover object-top duration-500 hover:scale-105 hover:shadow-xl"
                    src="{{ asset('images/galeria4.jpg') }}" alt="" />
            </div>
            
            <div class="w-full p-4 md:w-1/3">
                <img class="h-80 w-full rounded-lg object-cover object-top duration-500 hover:scale-105 hover:shadow-xl"
                    src="{{asset('images/galeria1.jpg')}}" alt="" />
            </div>
            <div class="w-full p-4 md:w-1/3">
                <img class="h-80 w-full rounded-lg object-cover object-top duration-500 hover:scale-105 hover:shadow-xl"
                    src="{{asset('images/galeria2.jpg')}}" alt="" />
            </div>
            <div class="w-full p-4 md:w-1/3">
                <img class="h-80 w-full rounded-lg object-cover object-top duration-500 hover:scale-105 hover:shadow-xl"
                    src="{{asset('images/galeria3.jpg')}}" alt="" />
            </div>
        </div>
    </div>
</section>
            ...
            <div class="flex flex-row flex-wrap">
                ...
                <div class="flex-shrink max-w-full w-full lg:w-1/2 pb-1 lg:pb-0 lg:pr-1">
                    <div class="relative hover-img max-h-98 overflow-hidden">
                        <a href="#">
                            <img class="max-w-full w-full mx-auto h-auto" src="{{asset('images/estudio.jpg')}}" alt="Image description">
                        </a>
                        <div class="absolute px-5 pt-8 pb-5 bottom-0 w-full bg-gradient-cover">
                            <a href="#">
                                <h2 class="text-3xl font-bold capitalize text-white mb-3">Estudio de tap</h2>
                            </a>
