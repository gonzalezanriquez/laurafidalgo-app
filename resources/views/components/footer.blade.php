<footer aria-label="Site Footer" class="bg-black text-white">
    <div class="mx-auto max-w-5xl px-4 py-5 sm:px-6 lg:px-8">
        ...
        <ul class="mt-6 flex justify-center gap-6 md:gap-8">
            <li>
                <a href="https://www.facebook.com/profile.php?id=100080035200807&sk=about" rel="noreferrer" target="_blank" class="text-gray-400 transition hover:text-teal-400">
            ...
            <li>
                <a href="https://www.instagram.com/laurafidalgo.studio" rel="noreferrer" target="_blank" class="text-gray-400 transition hover:text-teal-400">
