    ...
    <div class="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
        <a href="#">
            ...
            <div class="px-4 py-3 w-72">
                ...
                <div class="flex items-center">
                    <p class="  text-black cursor-auto my-3">Profesor de Teatro y Comedia Musical</p>
    ...
    kofiWidgetOverlay.draw('mohamedghulam', {
        ...
        <div class="relative flex flex-col mt-6 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-96">
            <div
              ...
              <img
                src="{{asset('images/docentes/Marcelo Duran.jpg')}} "class="object-cover w-full h-full
                alt="card-image" />
            </div>
            <div class="p-6">
          ...
          <div class="relative bg-gradient-to-r from-purple-600 to-blue-600 h-screen text-white overflow-hidden">
            <div class="absolute inset-0">
                <video autoplay loop muted playsinline class="object-cover object-center w-full h-full">
                    <source src="{{ asset('images/institucional.webm') }}" type="video/webm">
                </video>              <div class="absolute inset-0 bg-black opacity-30"></div>
            </div>
            
            <div class="relative z-10 flex flex-col justify-center items-center h-full text-center">
              {{-- <h1 class="text-5xl font-bold leading-tight mb-4">ACADEMIA</h1> --}}
              {{-- <p class="text-lg text-gray-300 mb-8">Discover amazing features and services that await you.</p> --}}
              <a href="#" class="bg-yellow-400 text-gray-900 hover:bg-yellow-300 py-2 px-6 rounded-full text-lg font-semibold transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg">ACADEMIA LAURA FIDALGO</a>
            </div>
          </div>
          
        {{-- <div class="relative w-full h-[30rem] md:h-[calc(100vh-106px)] bg-gray-100 rounded-2xl overflow-hidden px-8">
            <img src="{{ asset('images/estudio.jpg') }}" alt="Estudio" class="object-cover w-full h-full rounded-2xl">
            
            <div class="absolute inset-0 flex items-center justify-center rounded-xl">
                <div class="text-center px-5 md:px-10">
                    <h1 class="text-white text-3xl md:text-5xl font-bold">Nike React</h1>
                    <p class="text-white text-xl md:text-2xl mt-4">Rewriting sport's playbook for billions of athletes</p>
                    <div class="mt-5">
                        <a class="py-2 px-4 inline-flex items-center gap-x-2 text-sm md:text-base font-medium rounded-xl bg-white border border-transparent text-black hover:bg-gray-100 focus:outline-none focus:bg-gray-100" href="#">
                            Read Case Studies
                        </a>
                    </div>
                </div>
         ...
         <div class="group relative m-10 h-96 w-96 overflow-hidden rounded-lg shadow-md">
            ...
            <div class="absolute left-0 top-0 h-full w-full transition-all duration-300 ease-in-out group-hover:-top-96">
              ...
              <h1 class="mt-4 px-4 text-center font-serif text-xl font-semibold text-rose-500">Portugal's Hot Baloon Festival</h1>
